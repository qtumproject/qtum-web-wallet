export default {
  common: {
    ...
    notify: {
      ...
      mnemonics_are_not_same_as_the_words_should_remember:
        "니모닉이 기억해야 할 단어와 다릅니다.",
      mnemonics_can_not_restore:
        "그 니모닉은 지갑을 복원할 수 없습니다. 확인하고 다시 시도하십시오.",
      address_is_not_same_as_the_old_one:
        "이 주소는 이전 주소와 같지 않습니다.",
      ...
      restore_key_file_fail:
        "키 파일에서 복원에 실패했습니다. 패스워드가 올바르지 않을 수 있습니다.",
      connect_ledger_fail:
        "Ledger 연결 실패. Ledger를 다시 플러그인 하고 재시도하십시오.",
      token_contract_address_is_not_exists:
        "토큰 컨트랙트 주소가 없습니다. 확인한 후 다시 시도하십시오"
    },
    mode: {
      normal: "노멀",
      offline: "오프라인"
  ...
  file_creator: {
    download:
      '다운로드가 시작되지 않으면이 버튼을 클릭하여 파일 다운로드를 시작하십시오. 마우스 오른쪽 버튼으로 클릭하고 "링크를 다른 이름으로 저장 ..."을 선택할 수 있습니다.'
  },
  ledger: {
  ...
  safe_send: {
    ...
    fee: "수수료",
    info:
      '안전 전송을 완료하려면 두 대의 컴퓨터 (온라인과 오프라인 중 하나)와 제거 가능한 저장 장치가 필요합니다. 아래 팁을 따르는 경우 개인 키 누설의 위험은 없습니다. 오프라인 컴퓨터의 경우 "설정" - "모드"에서 "오프라인"을 선택한 다음 지갑을 복원하십시오.',
    info1_online:
      "양식을 작성한 다음 파일을 저장하고 오프라인 컴퓨터로 복사하십시오. 그리고 오프라인 컴퓨터의 2단계를 마칩니다.",
    info1_offline:
      "온라인 컴퓨터에서 1단계를 마치고 온라인 컴퓨터에서 파일을 복사한 다음 2단계로 이동하십시오.",
    info2_online:
      "오프라인 컴퓨터에서 이 단계를 완료하고 오프라인 컴퓨터에서 파일을 복사한 다음 3단계로 이동하십시오.",
    info2_offline:
      "온라인 컴퓨터에서 파일 복사본을 업로드하고 서명을 마친 다음 파일을 저장하고 다시 온라인 컴퓨터로 복사하십시오.",
    info3_online:
      "오프라인 컴퓨터에서 파일을 업로드한 다음 안전 전송을 완료하십시오.",
  ...
  restore: {
    title: "지갑 복원",
    mnemonic_warning:
      "입력한 단어는 bip39 니모닉이 아닙니다. 이 지갑에서 주소가 생성 된 경우 이 대화 상자를 취소 한 다음 단어를 확인하십시오 (공백이나 대문자가 없음). 단어를 두 번 확인했다면 계속 진행할 수 있습니다."
  },
  restore_wif: {
    title: "WIF에서 복원",
    priv_key: "WIF"
  ...
  restore_ledger: {
    title: "Ledger에서 복원",
    usage:
      '펌웨어 및 응용 프로그램이 최신 버전인지 확인하십시오. 귀하의 Ledger를 플러그인하고 Qtum APP을 실행한 다음 아래의 "연결" 버튼을 클릭하여 연결하십시오.',
    download:
      "Qtum APP이 없으신가요? 다음 항목을 설치하십시오 https://www.ledgerwallet.com/apps/manager",
    connect: "연결"
  },
  view: {
    title: "지갑 정보 보기"
  ...
  dump_as_key_file: {
    ...
    warning:
      "이 패스워드를 기억하십시오. 이 패스워드를 분실하면이 백업 파일을 더 이상 암호 해독 할 수 없습니다"
  },
  config: {
    title: "설정",
    lan: "언어",
